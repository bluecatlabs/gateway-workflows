...
# Description: Lease History Mac Address Access
...
def query_history_by_mac_endpoint(workflow_name, element_id, permissions, result_decorator=None):
    ...
    # pylint: disable=unused-argument
    endpoint = 'query_history_by_mac'
    function_endpoint = '%squery_history_by_mac' % workflow_name
    ...
    def query_history_by_mac():
        ...
        try:
            ...
            data = load_lease_history(configuration.get_id(), mac_address)
