...
# Description: Bulk Register IP Address Form
...
class GenericFormTemplate(GatewayForm):
    workflow_name = 'bulk_register_ip_address'
    workflow_permission = 'bulk_register_ip_address_page'

    text = get_resource_text()
    file = FileField(text['label_file'])

    ip_address_list = TableField(
