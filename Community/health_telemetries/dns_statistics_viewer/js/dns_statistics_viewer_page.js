...
// Description: Health Telemetry DNS Statistics Viewer Main Page JS
...
function construct_list(id) {
    ...
    $.ajax({
        type: 'GET',
        url: '/dns_statistics_viewer/load_col_model',
        async: false
    })
    .done(function(data) {
        title = data.title;
    ...
    var grid = $('#' + id);
    grid.jqGrid({
        url: '/dns_statistics_viewer/load_statistics?start=0&count=' + buffer_size,
        datatype: 'json',
        colModel: colModel,
        height: 216,
        rowNum: 10000,
...
function update_statistics_list() {
    ...
    $.ajax({
        type: "GET",
        url: '/dns_statistics_viewer/load_statistics',
        data: {
            start: 0,
            count: buffer_size
        },
...
function set_detail(key) {
    ...
    $.ajax({
        type: 'GET',
        url: '/dns_statistics_viewer/get_statistics/' + key,
        async: false
    })
    .done(function(data) {
