...
from .cisco_aci_example_form import GenericFormTemplate, raw_table_data
import ipaddress
...
# chaos will ensue.
@route(app, '/cisco_aci_example/cisco_aci_example_endpoint')
@util.workflow_permission_required('cisco_aci_example_page')
...
@route(app, '/cisco_aci_example/progress')
@util.rest_workflow_permission_required('cisco_aci_example_page')
def get_progress():
    """
...
# pylint: disable=broad-except
@route(app, '/cisco_aci_example/import_tenants', methods=['POST'])
@util.rest_workflow_permission_required('cisco_aci_example_page')
...
@route(app, '/cisco_aci_example/import_fabric', methods=['POST'])
@util.rest_workflow_permission_required('cisco_aci_example_page')
@util.rest_exception_catcher
def cisco_aci_example_cisco_aci_example_page_import_fabric():
    """
