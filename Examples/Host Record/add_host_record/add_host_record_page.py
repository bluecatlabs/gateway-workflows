...
from .add_host_record_form import GenericFormTemplate
...
# chaos will ensue.
@route(app, '/add_host_record/add_host_record_endpoint')
@util.workflow_permission_required('add_host_record_page')
@util.exception_catcher
def add_host_record_add_host_record_page():
    """
...
@route(app, '/add_host_record/form', methods=['POST'])
@util.workflow_permission_required('add_host_record_page')
@util.exception_catcher
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            if form.deploy_now.data:
                ...
                return render_template('add_host_record_page.html',
                                       form=form,
...
@route(app, '/add_host_record/get_deploy_status', methods=['POST'])
@util.rest_workflow_permission_required('add_host_record_page')
