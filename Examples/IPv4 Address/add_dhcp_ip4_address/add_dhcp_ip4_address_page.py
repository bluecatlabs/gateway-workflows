    ...
    if form.validate_on_submit():
        try:
            ...
            ip4_object = configuration.assign_ip4_address(
                str(request.form.get("ip4_address", "")),
                str(form.mac_address.data),
                hostinfo,
            ...
            return redirect(
                url_for("add_dhcp_ip4_addressadd_dhcp_ip4_address_add_dhcp_ip4_address_page")
            )
